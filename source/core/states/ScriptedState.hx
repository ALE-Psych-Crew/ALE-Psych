...
class ScriptedState extends State implements IScriptedState
{
    ...
    public function callOnHScripts(callback:String, ?args:Array<Dynamic>):Array<Dynamic>
    ...
    public function scriptCallbackCall(type:ScriptCallType, id:String, ?globalArgs:Array<Dynamic>, ?hxArgs:Array<Dynamic>, ?luaArgs:Array<Dynamic>):Bool
    {
        ...
        #if ALLOW_HSCRIPT
        result = result.concat(callOnHScripts(type.toString() + id, globalArgs.concat(hxArgs)));
        #end
