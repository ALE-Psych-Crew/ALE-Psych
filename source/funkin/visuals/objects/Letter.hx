...
import core.structures.LetterConfig;

class Letter extends FlxSprite
{
	public var image(default, set):String;

	public static var allLetters:Map<String, Null<LetterConfig>> = [
		//alphabet
	...
	public var curLetter:LetterConfig = null;
	public function setupAlphabetLetter(x:Float, y:Float, ?character:String = null, ?bold:Null<Bool> = null)
	{
		this.x = x;
		this.y = y;
